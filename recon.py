...
\033[31m%%%@%%%%%%%%%%%%%+%%%%%%+%%%%%%%%#*###%%%%%#%%%%%%%%%%%#%%%%%%%#+-==++++***######%%%%%%########%####\033[31m
	...
	\033[31m                  Subdomain Enumeration Tool v1.2 - Anij Gurung	\033[31m
	\033[31m                ---------------------------------------------	\033[31m
...
def enumerate_subdomains(domain, save_location):
    ...
    try:
        ...
        merge_command = f"sort -u {save_location}/subdomain1.txt {save_location}/subdomain2.txt {save_location}/subdomain3.txt > {save_location}/domain.txt"
        cleanup_command = f"rm {save_location}/subdomain1.txt {save_location}/subdomain2.txt {save_location}/subdomain3.txt"
